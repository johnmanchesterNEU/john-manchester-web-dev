 ...
 * Flickr using the OAuth protocol.
 *
 ...
 *       }
 *     ));
 * Chamge perms to delete to gain full access
...
function Strategy(options, verify) {
  ...
  options = options || {};
  options.oauth_nonce = flickrApi.generateNonce();
  options.oauth_signature_method =  'HMAC-SHA1';
  options.oauth_timestamp = flickrApi.generateTimestamp();
  //options.oauth_signature = flickrApi.signApiMethod();
  ...
  options.userAuthorizationURL = options.userAuthorizationURL || 'https://www.flickr.com/services/oauth/authorize?perms=delete';
  options.sessionKey = options.sessionKey || 'oauth:flickr';


  console.log("nonce : " + options.oauth_nonce);
